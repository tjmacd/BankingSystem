...
${OBJECTDIR}/_ext/5c0/AccountHelper.o: ../AccountHelper.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/AccountHelper.o ../AccountHelper.cpp

${OBJECTDIR}/_ext/5c0/FileStreamHelper.o: ../FileStreamHelper.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/FileStreamHelper.o ../FileStreamHelper.cpp

${OBJECTDIR}/_ext/5c0/FlippinFlapJacks.o: ../FlippinFlapJacks.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/FlippinFlapJacks.o ../FlippinFlapJacks.cpp

${OBJECTDIR}/_ext/5c0/TransactionsHelper.o: ../TransactionsHelper.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/TransactionsHelper.o ../TransactionsHelper.cpp

${OBJECTDIR}/_ext/5c0/stdafx.o: ../stdafx.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/stdafx.o ../stdafx.cpp
